...
describe('node-type-utils', () => {
  describe('normalizeNodeType', () => {
    it('should normalize n8n-nodes-base to nodes-base', () => {
      expect(normalizeNodeType('n8n-nodes-base.httpRequest')).toBe('n8n-nodes-base.httpRequest');
    ...
    it('should normalize @n8n/n8n-nodes-langchain to nodes-langchain', () => {
      expect(normalizeNodeType('@n8n/n8n-nodes-langchain.openAi')).toBe('@n8n/n8n-nodes-langchain.openAi');
      expect(normalizeNodeType('@n8n/n8n-nodes-langchain.chatOpenAi')).toBe('@n8n/n8n-nodes-langchain.chatOpenAi');
    });
  ...
  describe('denormalizeNodeType', () => {
    it('should denormalize nodes-base to n8n-nodes-base', () => {
      ...
      expect(denormalizeNodeType('n8n-nodes-base.webhook', 'base')).toBe('n8n-nodes-base.webhook');
    });
    ...
    it('should denormalize nodes-langchain to @n8n/n8n-nodes-langchain', () => {
      ...
      expect(denormalizeNodeType('@n8n/n8n-nodes-langchain.chatOpenAi', 'langchain')).toBe('@n8n/n8n-nodes-langchain.chatOpenAi');
    });
  ...
  describe('getNodePackage', () => {
    it('should extract package from normalized types', () => {
      expect(getNodePackage('n8n-nodes-base.httpRequest')).toBe('n8n-nodes-base');
      expect(getNodePackage('@n8n/n8n-nodes-langchain.openAi')).toBe('@n8n/n8n-nodes-langchain');
    });
  ...
  describe('isBaseNode', () => {
    it('should identify base nodes correctly', () => {
      expect(isBaseNode('n8n-nodes-base.httpRequest')).toBe(true);
      expect(isBaseNode('n8n-nodes-base.webhook')).toBe(true);
      expect(isBaseNode('n8n-nodes-base.slack')).toBe(true);
    });

    it('should reject non-base nodes', () => {
      expect(isBaseNode('@n8n/n8n-nodes-langchain.openAi')).toBe(false);
  ...
  describe('isLangChainNode', () => {
    it('should identify langchain nodes correctly', () => {
      expect(isLangChainNode('@n8n/n8n-nodes-langchain.openAi')).toBe(true);
      expect(isLangChainNode('@n8n/n8n-nodes-langchain.chatOpenAi')).toBe(true);
      expect(isLangChainNode('@n8n/n8n-nodes-langchain.vectorStore')).toBe(true);
    });

    it('should reject non-langchain nodes', () => {
      expect(isLangChainNode('n8n-nodes-base.httpRequest')).toBe(false);
  ...
  describe('isValidNodeTypeFormat', () => {
    it('should validate correct node type formats', () => {
      expect(isValidNodeTypeFormat('n8n-nodes-base.httpRequest')).toBe(true);
      expect(isValidNodeTypeFormat('n8n-nodes-base.webhook')).toBe(true);
      expect(isValidNodeTypeFormat('@n8n/n8n-nodes-langchain.openAi')).toBe(true);
    ...
    it('should reject invalid formats', () => {
      ...
      expect(isValidNodeTypeFormat('n8n-nodes-base.')).toBe(false); // No node name
      expect(isValidNodeTypeFormat('.httpRequest')).toBe(false); // No package
  ...
  describe('getNodeTypeVariations', () => {
    ...
    it('should generate variations for normalized base node', () => {
      const variations = getNodeTypeVariations('n8n-nodes-base.httpRequest');
      expect(variations).toContain('n8n-nodes-base.httpRequest');
      expect(variations).toContain('n8n-nodes-base.httpRequest');
    ...
    it('should generate variations for normalized langchain node', () => {
      const variations = getNodeTypeVariations('@n8n/n8n-nodes-langchain.openAi');
